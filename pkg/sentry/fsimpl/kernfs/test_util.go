...
// Package kernfstest provides common test utilities for kernfs-based
// filesystems.
package kernfstest
...
func NewSystem(ctx context.Context, t *testing.T, v *vfs.VirtualFilesystem, mns *vfs.MountNamespace) *System {
	...
	runtime.SetFinalizer(s, func(s *System) { s.mns.Root().DecRef() })
	return s
}
...
// AssertDirectoryContains veries that a directory at pop contains the
// entries specified. AssertDirectoryContains implicitly checks for
// "." and "..", these need not be included in entries.
